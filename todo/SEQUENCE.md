...
- [ ] SEQ-014 P4: Draft-PR mode for the one case `[skip ci]` cannot reach — a protected `main` that forbids direct pushes. BLOCKED ON EVIDENCE: do not implement until an enrolled unit actually has one (Appendix C's posture). Design is done, not the build → research/2026-08-13-ops-draft-pr-mode.md
